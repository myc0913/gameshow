...
1. **00:00-00:20** — 展示符文池，点击 4 枚符文填入槽位，拖拽调整顺序
2. **00:20-00:40** — 点击「铭刻生成」，查看技能结果（名称、标签、参数条），观察 3D 动画播放
3. **00:40-01:00** — 点击「默认对比样例」，查看 A/B 两个构筑的并排对比，高亮维度差异
4. **01:00-01:20** — 切换到 **How** 页，展示完整 trace：基础快照 → 前向互馈 → 后向修饰 → 最终解码
5. **01:20-01:40** — How 页底部 A/B 对比，展示相同符文不同顺序的维度变化
6. **01:40-02:00** — 切换到 **Why** 页，简述设计理念和与《漂流诸天》道痕系统的关系
